...
A simple C++ implementation is added as `2.cpp`.
...
### Notes
- Logic is same as the C program: read DFA definition, process input string, print `Valid string` or `Invalid string`.
